 ...
 *   <li>{@link reactNative.View#getViewToSectionList <em>View To Section List</em>}</li>
 * </ul>
 *
...
public interface View extends EObject {
	...
	/**
	 * Returns the value of the '<em><b>View To Section List</b></em>' containment reference.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>View To Section List</em>' containment reference isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>View To Section List</em>' containment reference.
	 * @see #setViewToSectionList(SectionList)
	 * @see reactNative.ReactNativePackage#getView_ViewToSectionList()
	 * @model containment="true"
	 * @generated
	 */
	SectionList getViewToSectionList();

	/**
	 * Sets the value of the '{@link reactNative.View#getViewToSectionList <em>View To Section List</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>View To Section List</em>' containment reference.
	 * @see #getViewToSectionList()
	 * @generated
	 */
	void setViewToSectionList(SectionList value);
