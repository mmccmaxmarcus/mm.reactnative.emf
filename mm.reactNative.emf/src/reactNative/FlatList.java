 ...
 *   <li>{@link reactNative.FlatList#getFlatListToArray <em>Flat List To Array</em>}</li>
 * </ul>
 *
...
public interface FlatList extends EObject {
	...
	/**
	 * Returns the value of the '<em><b>Flat List To Array</b></em>' containment reference list.
	 * The list contents are of type {@link reactNative.Array}.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Flat List To Array</em>' containment reference list isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Flat List To Array</em>' containment reference list.
	 * @see reactNative.ReactNativePackage#getFlatList_FlatListToArray()
	 * @model containment="true"
	 * @generated
	 */
	EList<Array> getFlatListToArray();
