 ...
 *   <li>{@link reactNative.Image#getSubImage <em>Sub Image</em>}</li>
...
public interface Image extends EObject {
	...
	/**
	 * Returns the value of the '<em><b>Sub Image</b></em>' containment reference list.
	 * The list contents are of type {@link reactNative.Image}.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Sub Image</em>' containment reference list isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Sub Image</em>' containment reference list.
	 * @see reactNative.ReactNativePackage#getImage_SubImage()
	 * @model containment="true"
	 * @generated
	 */
	EList<Image> getSubImage();
