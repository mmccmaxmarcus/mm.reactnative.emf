 ...
 *   <li>{@link reactNative.impl.FlatListImpl#getFlatListText <em>Flat List Text</em>}</li>
 *   <li>{@link reactNative.impl.FlatListImpl#getFlatlistName <em>Flatlist Name</em>}</li>
 *   <li>{@link reactNative.impl.FlatListImpl#getImage <em>Image</em>}</li>
...
public class FlatListImpl extends MinimalEObjectImpl.Container implements FlatList {
	...
	/**
	 * The cached value of the '{@link #getFlatListText() <em>Flat List Text</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getFlatListText()
	 * @generated
	 * @ordered
	 */
	protected EList<Text> flatListText;
	 ...
	 * @generated
	 */
	public EList<Text> getFlatListText() {
		if (flatListText == null) {
			flatListText = new EObjectContainmentEList<Text>(Text.class, this, ReactNativePackage.FLAT_LIST__FLAT_LIST_TEXT);
		}
		return flatListText;
	}
	...
	public EList<Image> getImage() {
		if (image == null) {
			image = new EObjectContainmentEList<Image>(Image.class, this, ReactNativePackage.FLAT_LIST__IMAGE);
		}
		return image;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case ReactNativePackage.FLAT_LIST__FLAT_LIST_TEXT:
				return ((InternalEList<?>)getFlatListText()).basicRemove(otherEnd, msgs);
			case ReactNativePackage.FLAT_LIST__IMAGE:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ReactNativePackage.FLAT_LIST__HAS_VIEWS:
				...
				return;
			case ReactNativePackage.FLAT_LIST__FLAT_LIST_TEXT:
				getFlatListText().clear();
				getFlatListText().addAll((Collection<? extends Text>)newValue);
				return;
			case ReactNativePackage.FLAT_LIST__FLATLIST_NAME:
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case ReactNativePackage.FLAT_LIST__FLAT_LIST_TEXT:
				return flatListText != null && !flatListText.isEmpty();
			case ReactNativePackage.FLAT_LIST__FLATLIST_NAME:
