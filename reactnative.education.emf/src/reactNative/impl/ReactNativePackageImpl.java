...
public class ReactNativePackageImpl extends EPackageImpl implements ReactNativePackage {
	 ...
	 * @generated
	 */
	public EReference getText_SubText() {
	 ...
	 * @generated
	 */
	public EReference getFlatList_FlatListText() {
		return (EReference)flatListEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getFlatList_Image() {
		return (EReference)flatListEClass.getEStructuralFeatures().get(3);
	}
	...
	public EAttribute getFlatList_RenderItem() {
		return (EAttribute)flatListEClass.getEStructuralFeatures().get(5);
	}
	...
	public EAttribute getFlatList_KeyExtractor() {
		return (EAttribute)flatListEClass.getEStructuralFeatures().get(6);
	}
	 ...
	 * @generated
	 */
	public EReference getImage_SubImage() {
	...
	public void createPackageContents() {
		...
		createEReference(textEClass, TEXT__SUB_TEXT);
		...
		createEReference(flatListEClass, FLAT_LIST__FLAT_LIST_TEXT);
		createEAttribute(flatListEClass, FLAT_LIST__FLATLIST_NAME);
		createEReference(flatListEClass, FLAT_LIST__IMAGE);
		...
		createEReference(imageEClass, IMAGE__SUB_IMAGE);
	...
	public void initializePackageContents() {
		...
		initEReference(getText_SubText(), this.getText(), null, "subText", null, 0, -1, Text.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getFlatList_FlatListText(), this.getText(), null, "flatListText", null, 0, -1, FlatList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getFlatList_Image(), this.getImage(), null, "image", null, 0, -1, FlatList.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getImage_SubImage(), this.getImage(), null, "subImage", null, 0, -1, Image.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
