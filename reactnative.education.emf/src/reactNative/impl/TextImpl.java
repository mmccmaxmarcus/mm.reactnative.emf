 ...
 *   <li>{@link reactNative.impl.TextImpl#getSubText <em>Sub Text</em>}</li>
...
public class TextImpl extends MinimalEObjectImpl.Container implements Text {
	...
	/**
	 * The cached value of the '{@link #getSubText() <em>Sub Text</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getSubText()
	 * @generated
	 ...
	 * @generated
	 */
	public EList<Text> getSubText() {
		if (subText == null) {
			subText = new EObjectContainmentEList<Text>(Text.class, this, ReactNativePackage.TEXT__SUB_TEXT);
		}
		return subText;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ReactNativePackage.TEXT__SUB_TEXT:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ReactNativePackage.TEXT__SUB_TEXT:
				getSubText().clear();
				getSubText().addAll((Collection<? extends Text>)newValue);
				return;
			case ReactNativePackage.TEXT__NAME:
