 ...
 *   <li>{@link reactNative.Text#getSubText <em>Sub Text</em>}</li>
...
public interface Text extends EObject {
	...
	/**
	 * Returns the value of the '<em><b>Sub Text</b></em>' containment reference list.
	 * The list contents are of type {@link reactNative.Text}.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Sub Text</em>' containment reference list isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Sub Text</em>' containment reference list.
	 * @see reactNative.ReactNativePackage#getText_SubText()
	 * @model containment="true"
	 * @generated
	 */
	EList<Text> getSubText();
