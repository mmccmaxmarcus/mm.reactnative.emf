...
/**
 * This is the item provider adapter for a {@link reactNative.Font} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FontItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Font_fontSize_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Font_fontSize_feature", "_UI_Font_type"),
				 ReactNativePackage.Literals.FONT__FONT_SIZE,
				 true,
				 false,
				 false,
	...
	protected void addFontFamilyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Font_fontFamily_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Font_fontFamily_feature", "_UI_Font_type"),
				 ReactNativePackage.Literals.FONT__FONT_FAMILY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addFontWeightPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Font_fontWeight_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Font_fontWeight_feature", "_UI_Font_type"),
				 ReactNativePackage.Literals.FONT__FONT_WEIGHT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Font)object).getFontSize();
